...
public class Interval extends TemporalEntity {
	...
	/**
	 * A map for instances of this class. This is required to ensure that only one instance of this class is created for each interval.
	 */
	private static Map<Float, Interval> intervals;
	
	/**
	 * Retrieves an instance of <tt>Interval</tt> for the given period of time. The method either returns an instance that has already been created previously or creates a new instance of no instance for the given period has previously been created.
	 *  
	 * @param time period of time for which to return an instance of <tt>Interval</tt>
	...
	/**
	 * Retrieves an instance of <tt>Interval</tt> for the period of time between now and the given date. The method either returns an instance that has already been created previously or creates a new instance of no instance for the given period has previously been created.
	 *  
	 * @param time end of the period of time for which to return an instance of <tt>Interval</tt>
	...
	/**
	 * Constructor that creates an instance of <tt>Interval</tt> given its unique name and the period of time it represents.
	 * This constructor is private to enforce all instances of <tt>Interval</tt> to be created by the method {@link #getInterval(float)}.
	 * 
	 * @param name unique name which is to be used in the ontology as name for the individual which corresponds to this instance 
	 * @param time the period of time this instance of <tt>Interval</tt> represents
	 */
	...
	/**
	 * Constructor that creates an instance of <tt>Interval</tt> given its unique name and the end date of the period of time it represents.
	 * The current time is selected to be the beginning of the time period.
	 * This constructor is private to enforce all instances of <tt>Interval</tt> to be created by the method {@link #getInterval(Date)}.
	 * 
	 * @param name unique name which is to be used in the ontology as name for the individual which corresponds to this instance 
	 * @param date the end date of the period of time this instance of <tt>Interval</tt> represents
	 */
	...
	/**
	 * This method returns the number of hours between the current time and the specified date if the specified date is in the future, 0 otherwise.
	 * 
	 * @param date an arbitrary date
	 * @return the number of seconds between the current time and the specified date if the specified date is in the future, 0 otherwise
	 */
