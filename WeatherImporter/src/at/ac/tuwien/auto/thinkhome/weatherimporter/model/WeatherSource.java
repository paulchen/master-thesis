...
/**
 * This class represents a source of weather data (either a {@link Instant} or an {@link Interval}).
 * 
 * @author Paul Staroch
 *
 */
public abstract class WeatherSource implements OntologyClass {
	...
	/**
	 * Returns the name of the concept in the ontology this class corresponds to.
	 * 
	 * @return the name of the concept in the ontology this class corresponds to.
	 */
