...
/**
 * This class represents anything that is mapped into an individual when the individuals for the ontology are generated.
 * 
 * @author Paul Staroch
 */
public interface OntologyClass {
	 ...
	 *  
	 * @param onto ontology where to add the individuals to
	 */
	public void createIndividuals(OntModel onto);

	/**
	 * Once {@link #createIndividuals(OntModel)} has been called for this instance, this contains the main individual in the ontology that has been created by that method call.
	 * 
