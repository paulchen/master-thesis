...
\newglossaryentry{sun position}{
  ...
  see={day,night,twilight,solar twilight,nautical twilight,astronomical twilight,civil twilight,sun from east,sun from south,sun from west,sun from north,twilight}
}
\newglossaryentry{day}{
  name={day},
...
\newglossaryentry{atmospheric pressure}{
  ...
  description={TODO},
  see={} % TODO reference subconcepts
}
...
\newglossaryentry{cloud cover}{
  ...
  see={okta,clear sky,partly cloudy,mostly cloudy,overcast,unknown cloud cover}
}
...
% TODO reference WGS84
\newglossaryentry{location}{
  name={location},
  description={Geographical position a \emph{weather report} is valid for, given by \emph{altitude}, \emph{longitude} and \emph{latitude}},
...
\newglossaryentry{altitude}{
  name={altitude},
  description={Height above \emph{MSL} of the \emph{location} the \emph{weather report} is valid for, in metres},
  see={weather report,msl,location} % TODO msl
}
...
\newglossaryentry{weather state}{
  name={weather state},
  description={TODO},
  see={weather report,weather phenomenon} % TODO more links?
}
