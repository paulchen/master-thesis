...
\newglossaryentry{has cloud cover}{
  ...
  description={Property that specifies the cloud coverage of a cloud layer represented by an instance of \emph{Cloud cover}. This property makes use of concepts and properties defined by the \emph{Measurement Units Ontology}~\cite{MUO} to provide both a value and its unit; \smarthomeweather specifies the cloud coverage in \eacs{okta}},
  see={cloud cover}
}
