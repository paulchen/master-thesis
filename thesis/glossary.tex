...
\newglossaryentry{weather report}{ % TODO link weather source
  name={weather report},
...
\newglossaryentry{forecast weather report}{
  ...
  see={weather report,observation time,long range weather report,short range weather report,medium range weather report} % TODO sort
}
...
\newglossaryentry{observation time}{% TODO property?
...
\newglossaryentry{start time}{% TODO property?
  name={start time},
...
\newglossaryentry{end time}{% TODO property?
  name={end time},
...
\newglossaryentry{priority}{% TODO property?
  name={priority},
...
\newglossaryentry{no rain}{
  name={no rain},
  description={Sub-concept of \emph{Precipitation} representing absence precipitation (because either the chance or the intensity of precipitation is 0)},
  see={precipitation}
}
\newglossaryentry{light rain}{
  name={light rain},
  description={Sub-concept of \emph{Precipitation} representing precipitation of more than 0 and at most \unit{5}\milli\metre\per\hour},
  see={precipitation}
}
\newglossaryentry{medium rain}{
  name={medium rain},
  description={Sub-concept of \emph{Precipitation} representing precipitation of more than 5 and at most \unit{20}\milli\metre\per\hour},
  see={precipitation}
}
\newglossaryentry{heavy rain}{
  name={heavy rain},
  description={Sub-concept of \emph{Precipitation} representing precipitation of more than 20 and at most \unit{50}\milli\metre\per\hour},
  see={precipitation}
}
\newglossaryentry{extremely heavy rain}{
  name={extremely heavy rain},
  description={Sub-concept of \emph{Precipitation} representing precipitation of more than 50 and at most \unit{100}\milli\metre\per\hour},
  see={precipitation}
}
\newglossaryentry{tropical storm rain}{
  name={tropical storm rain},
  description={Sub-concept of \emph{Precipitation} representing precipitation of more than \unit{100}\milli\metre\per\hour},
  see={precipitation}
}
...
\newglossaryentry{location}{% TODO concept?
  name={location},
...
\newglossaryentry{weather phenomenon}{
  ...
  description={A concept that represents a certain weather element. Relevant weather elements are \emph{Temperature}, \emph{Humidity}, \emph{Dew point}, \emph{Wind}, \emph{Precipitation}, \emph{Atmospheric pressure}, \emph{Cloud cover}, \emph{Solar radiation}, and the \emph{Sun position}}, % TODO sort
  see={temperature,humidity,dew point,wind,precipitation,atmospheric pressure,cloud cover,solar radiation,sun position} % TODO sort
}
...
\newglossaryentry{weather}{
  name={weather},
  description={A concept that represents all available weather data. Each instance \emph{Weather report} is linked to the same instance of \emph{Weather}},
  see={weather report}
}
