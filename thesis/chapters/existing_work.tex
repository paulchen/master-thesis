...
Another core principle of an ontology is reusability\cite{reuse1,reuse2}. In order to share knowledge across various systems, ontologies are often reused within other ontologies. Besides the simplification of knowledge sharing, this principle tries to avoid duplicate work and reduces the work that is necessary to create an ontology for a domain.
