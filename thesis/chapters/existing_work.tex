...
\eacs{RDFS} comes with reasoning support; e.g. in the above example, the statements
...
% TODO link W3C life cycle for specifications

Many of the concepts and properties defined are included in the \emph{Web Ontology Language} (\eacs{OWL}), a more expressive ontology language than \eacs{RDFS} based on \eacs{RDF} and \eacs{RDFS}. \eacs{OWL} is developed by the \emph{OWL Working Group} of the \emph{W3C consortium}. \eacs{OWL} 1 was first published in July 2002 as a working draft and became a \emph{W3C recommendation} in February 2004; the first working draft of \eacs{OWL} 2 in March 2009 and the \emph{W3C recommendation} of \eacs{OWL} 2 in October 2009 with a second edition being finally released in December 2012. \eacs{OWL} 2 remains fully compatible to \eacs{OWL} 1, i.e. all \eacs{OWL} 1 ontologies are also \eacs{OWL} 2 ontologies, with unchanged semantics.
