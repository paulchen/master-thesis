...
This section covers \emph{Semantic Sensor Web} (section~\ref{subsec:onto1}), the \emph{\eacs{SSN} ontology} (section~\ref{subsec:onto2}), \emph{NextGen} (section~\ref{subsec:onto4}), and \emph{\eacs{SWEET}} (section~\ref{subsec:onto5}). There are several other approaches such as in the \emph{SENSEI project}~\cite{sensei} which are not covered here.
