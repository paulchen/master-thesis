...
% TODO citation SSN-XG, ontology

Another approach towards semantically enriched sensor network based on \eacs{SWE} is an \emph{\eacs{OWL} 2} ontology created by the \emph{\eacs{W3C} Semantic Sensor Network Incubator group} (\eacs{SSN-XG}) which is referred to as the \emph{\eacs{SSN} Ontology}. 
% TODO
