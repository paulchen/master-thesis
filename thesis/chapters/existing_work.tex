...
\begin{itemize} % TODO citations
  \item \textbf{\eacs{DOAP}}: \eacs{DOAP}\footnote{\href{https://github.com/edumbill/doap/}{https://github.com/edumbill/doap/}} (\emph{Description of a Project}) is an \eacs{RDFS} vocabulary for describing software projects.
  ...
  \item \textbf{\eacs{SIOC}}: The \eacs{SIOC} ontology\footnote{\href{http://xmlns.com/foaf/spec/}{http://xmlns.com/foaf/spec/}}~\cite{SIOC} is an \eacs{RDFS} ontology for encoding information from Internet discussion methods (message boards, blogs, mailing lists etc.).
