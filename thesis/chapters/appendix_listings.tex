% TODO put all tables into tabular environments
...
\begin{itemize}
  \item \emph{Concept dictionaries} for \Egls{weather condition} (figure~\ref{fig:concept_dict1}), \Egls{weather phenomenon} (figure~\ref{fig:concept_dict2}), \Egls{weather report} (figure~\ref{fig:concept_dict3}), \Egls{weather state} (figure~\ref{fig:concept_dict4}), and \Egls{weather source} (figure~\ref{fig:concept_dict5}); see section~\ref{subsec:concept_dictionaries} for details about \emph{concept dictionaries}.
  ...
  \item The \emph{Class attributes table} in figure~\ref{fig:class_attributes_table1}, figure~\ref{fig:class_attributes_table2}, and  figure~\ref{fig:class_attributes_table3}; see section~\ref{subsec:class_attributes_table} for details.
...
\begin{tabular}{|p{.2\textwidth}|p{.5\textwidth}|p{.2\textwidth}|}
  ...
  \hline
\end{tabular}
\caption{Concept dictionary for \egls{weather condition}}
...
\begin{tabular}{|p{.25\textwidth}|p{.3\textwidth}|p{.35\textwidth}|}
  ...
  \hline
\end{tabular}
\caption{Concept dictionary for \egls{weather phenomenon}}
...
\begin{tabular}{|p{.2\textwidth}|p{.3\textwidth}|p{0.35\textwidth}|}
  ...
  \hline
\end{tabular}
\caption{Concept dictionary for \egls{weather report}}
...
\begin{table}
\centering
\begin{tabular}{|p{0.167\textwidth}|p{0.167\textwidth}|}
  \hline
  ...
  \hline
\end{tabular}
\caption{Concept dictionary for \egls{weather state}}
...
\begin{tabular}{|p{0.3\textwidth}|p{0.6\textwidth}|}
  ...
  \hline
\end{tabular}
\caption{Concept dictionary for \egls{weather source}}
