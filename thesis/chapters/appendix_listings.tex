...
\begin{itemize}
  \item \emph{Concept dictionaries} for \Egls{weather condition}, \Egls{weather state}, and \Egls{weather source} (Table~\ref{table:concept_dict1}), and for \Egls{weather phenomenon} and \Egls{weather report} (Table~\ref{table:concept_dict2}); see Section~\ref{subsec:concept_dictionaries} for details about \emph{concept dictionaries}.
...
\begin{tabular}{|p{.2\textwidth}|p{.2\textwidth}|p{.5\textwidth}|}
  ...
  \hline
\end{tabular}
\caption[Concept dictionary (1)]{Concept dictionary for \Egls{weather condition}, \Egls{weather state}, and \Egls{weather source}.}
...
\begin{table}
\centering
\begin{tabular}{|p{0.17\textwidth}|p{0.13\textwidth}|p{0.13\textwidth}|p{0.13\textwidth}|p{0.12\textwidth}|p{0.12\textwidth}|}
  \hline
...
\begin{table}
\centering
\begin{tabular}{|p{0.15\textwidth}|p{0.23\textwidth}|p{0.3\textwidth}|p{0.13\textwidth}|}
  \hline
...
\begin{table}
\centering
\begin{tabular}{|p{0.17\textwidth}|p{0.19\textwidth}|p{0.3\textwidth}|p{0.21\textwidth}|}
  \hline
  \textbf{Super-concept} & \textbf{Sub-concept} & \textbf{Attribute name} & \textbf{Attribute value(s)} \\
  \hline\hline
...
\begin{table}
\centering
\begin{tabular}{|p{0.20\textwidth}|p{0.29\textwidth}|p{0.20\textwidth}|p{0.18\textwidth}|}
  \hline
  \textbf{Super-concept} & \textbf{Sub-concept} & \textbf{Attribute name} & \textbf{Attribute value(s)} \\
  \hline\hline
...
weather:weatherReport0      weather:hasWeatherState               weather:weatherReport0 .
...
weather:weatherReport1      weather:hasWeatherState               weather:weatherReport1 .
\end{minted}
\vspace{3mm}\end{minipage}\end{minipage}};\end{tikzpicture}