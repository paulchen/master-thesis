...
TODO example code
  ...
  In the case of these concepts, the \eacs{OWL} reasoner does not infer any sub-concept relationships that are not explicitely defined.
...
\begin{itemize}
  ...
  \item \Egls{calm weather} is a weather state describing no or at least light wind. An instance of \Egls{calm weather} is related to an instance of either \Egls{calm} or \Egls{light wind} via the property \egls{has weather phenomenon}. \Egls{calm weather} is used to simplify the definition of \Egls{fair weather}.
