...
As previously stated, not all competency questions from the specification can be answered using an \eacs{OWL} ontology alone; reasons are that the

The competency questions that require \eacs{SPARQL} queries and/or \eacs{SWRL} rules can be grouped into three categories of questions:
\begin{itemize}
