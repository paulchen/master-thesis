...
The idea behind this approach is to provide simple answers to some of the competency questions. Except the concept \Egls{weather state}, every concept from this tree is defined to be a sub-concept of \Egls{weather state} and to be related to a set of instances of \Egls{weather phenomenon} and \Egls{weather condition} that have certain properties. In total, there are \num{19} sub-concepts of \Egls{weather state}; their definitions and their roles in the ontologies and in performing weather-related tasks in a smart home are presented below.

The sub-concepts of \Egls{weather state} are:

\begin{itemize}
  \item \Egls{airing weather}: % TODO
  
  \item \Egls{calm weather}: % TODO
  
  \item \Egls{clear weather}: % TODO
  
  \item \Egls{cloudy weather}: % TODO
  
  \item \Egls{cold weather}: % TODO
  
  \item \Egls{dry weather}: % TODO
  
  \item \Egls{fair weather}: % TODO
  
  \item \Egls{hot weather}: % TODO
  
  \item \Egls{moist weather}: % TODO
  
  \item \Egls{no awning weather}: % TODO
  
  \item \Egls{no rain weather}: % TODO
  
  \item \Egls{pleasant temperature weather}: % TODO
  
  \item \Egls{rainy weather}: % TODO

  \item \Egls{severe weather}: % TODO
  
  \item \Egls{stormy weather}: % TODO
  
  \item \Egls{sun protection weather}: % TODO
  
  \item \Egls{thunderstorm}: % TODO
  
  \item \Egls{very rainy weather}: % TODO
  
  \item \Egls{windy weather}: % TODO
\end{itemize}


The sub-concept relationships as shown in Figure~\ref{fig:tree_weather_state} are a result of the reasoning process and stem from the definitions of the concepts. % TODO
...
% TODO mention unnecssary checks in SPARQL queries: e.g. ?x a weather:WeatherReport, ?s a time:Interval 

% TODO example: SPARQL maximum value
\begin{lstlisting}
...
% TODO example: SPARQL maximum value, >0, <=3 hours
\begin{lstlisting}
SELECT (MAX(?t) AS ?t_max)
WHERE {
...
% TODO example: SPARQL maximum value, ShortRangeForecastReport
\begin{lstlisting}
SELECT (MAX(?t) AS ?t_max)
WHERE {
    ?p weather:hasTemperatureValue ?v.
...
% TODO example: SPARQL temperature value < 0
\begin{lstlisting}
SELECT ?s
WHERE {
...
% TODO example: SPARQL temperature frost
\begin{lstlisting}
SELECT ?s
WHERE {
    ?s weather:hasWeatherPhenomenon ?p.
...
% TODO example: SPARQL temperature, ShortRangeForecastReport
\begin{lstlisting}
SELECT ?s
WHERE {
    ?s weather:hasWeatherPhenomenon ?p.
...
% TODO example: SPARQL hasNextWeatherState
\begin{lstlisting}
SELECT ?s1 ?s2
WHERE {
...
% TODO example: SPARQL rising temperature
\begin{lstlisting}
SELECT ?s1 ?s2
WHERE {
...
% TODO example: SWRL hasLaterWeatherState
\begin{lstlisting}
...
% TODO example: SWRL increasingTemperature
\begin{lstlisting}
...
% TODO example: SPARQL increasingTemperature
\begin{lstlisting}
SELECT ?s1 ?s2
WHERE {
