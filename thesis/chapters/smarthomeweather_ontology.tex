...
\begin{itemize}
  ...
  \item \Egls{precipitation} (figure~\ref{fig:tree_precipitation}):
  
  \item \Egls{solar radiation} (figure~\ref{fig:tree_solar_radiation}):
  
  \item \Egls{sun position} (figure~\ref{fig:tree_sun_position}):
  
  \item \Egls{temperature} (figure~\ref{fig:tree_temperature}):
  
  \item \Egls{wind} (figure~\ref{fig:tree_wind}).
\end{itemize}
