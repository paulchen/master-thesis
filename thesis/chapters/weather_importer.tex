...
\end{minted}
\vspace{3mm}\end{minipage}\end{minipage}};\end{tikzpicture}
\caption{Example statements modified by \emph{Weather Importer} running in \texttt{timestamps} mode about two hours after the running it in \texttt{fetch} mode. See Listing~\ref{listing:importer_timestamps1} for the statements generated in the initial run.}
