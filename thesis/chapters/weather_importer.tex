...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{figures/diagrams/importer-model.eps}
...
\begin{figure}
\centering
\includegraphics[width=.5\textwidth]{figures/diagrams/importer-model-simple.eps}
...
\begin{figure}
\centering
\includegraphics[width=.7\textwidth]{figures/diagrams/turtlestore.eps}
