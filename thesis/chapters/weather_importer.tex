...
\begin{enumerate}
  ...
  \item One or more test individuals together with their properties are added to the in-memory ontology. E.g. when testing the correct functionality of the sub-concept \Egls{room temperature} of \Egls{temperature}, an instance of \Egls{weather phenomenon} is generated together with a property of type \egls{has temperature value} that assigns the value of \SI{20}{\celsius} to the \Egls{weather phenomenon} using the \muo ontology.
