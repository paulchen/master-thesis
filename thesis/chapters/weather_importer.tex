...
\begin{itemize}
  ...
  \item Alternatively, the timestamps of all instances of the \Egls{weather report} concept can be changed in order to make them correspond to the current time.
\end{itemize}
