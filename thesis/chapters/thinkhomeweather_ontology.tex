...
\muo is an ontology that is easy to implement in an already-existing ontology. However, 
...
\begin{figure}
  ...
  \caption{An instance of \emph{Weather report} together with its location (Vienna, Austria: $48.21 \si{\degree} N$, $16.37 \si{\degree} E$, $171 m$ above MSL.}
  \label{fig:owl_wgs84}
\end{figure}
