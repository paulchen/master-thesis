...
During the \emph{inception phase}, …. The \emph{elaboration phase} …. In the \emph{construction phase} …. Eventually, in the \emph{transition phase} ….

The \emph{requirements workflow} …. The \emph{analysis workflow} …. The \emph{design workflow} …. The \emph{implementation workflow} …. Finally, the \emph{test workflow} ….
...
\hline
\eacs{UPON} & … & Huge development effort \\
\hline
