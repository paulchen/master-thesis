...
By using well-established Semantic Web technologies for its knowledge base and field-tested methods from \eacs{AI}, \thinkhome is able to provide a both flexible and powerful infrastructure which is suitable for dealing with the complexity of smart homes in an efficient and manageable way.
