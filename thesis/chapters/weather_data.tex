...
\begin{itemize}
  ...
  The less complicated a request is, the better the service is suitable for \smarthomeweather. Requests in \eacs{HTTP}~\cite{rfc2616} are preferred due to the simplicity of performing requests on the client side in Java using the \emph{Apache HttpComponents project}~\cite{apache_hc}.
...
% TODO table headers: name -> weather service
% TODO sort weather services alphabetically
...
\begin{tabular}{|l|l||c|c|c|c|c|c|c|c|c|}
  \hline
  ~ & ~ & \rotatebox{90}{\textbf{DWD}} & \rotatebox{90}{\textbf{Google Weather Feed}} & \rotatebox{90}{\textbf{\acs{METAR}}} & \rotatebox{90}{\textbf{\acs{NWS}}} & \rotatebox{90}{\textbf{Weather.com}} & \rotatebox{90}{\textbf{Weather Underground}} & \rotatebox{90}{\textbf{World Weather Online~}} & \rotatebox{90}{\textbf{Yahoo! Weather}} & \rotatebox{90}{\textbf{yr.no}} \\
  \hline\hline
  \multirow{10}{*}{\rotatebox{90}{\textbf{Current weather}}} & \textbf{Cloud coverage} & \checkmark & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Condition} & \checkmark & \checkmark & $\times$ & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Dew point} & $\times$ & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Humidity} & \checkmark & \checkmark & $\times$ & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Precipitation} & \checkmark & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Pressure} & \checkmark & $\times$ & \checkmark & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Sunrise, sunset} & $\times$ & $\times$ & $\times$ & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Temperature} & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Visibility} & $\times$ & $\times$ & \checkmark & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Wind} & \checkmark & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \hline\hline
  \multirow{10}{*}{\rotatebox{90}{\textbf{Future weather}}} & \textbf{Cloud coverage} & $\times$ & $\times$ & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Condition} & \checkmark & \checkmark & $\times$ & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Dew point} & $\times$ & $\times$ & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Humidity} & $\times$ & $\times$ & $\times$ & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Precipitation} & $\times$ & $\times$ & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Pressure} & $\times$ & $\times$ & $\times$ & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Sunrise, sunset} & $\times$ & $\times$ & $\times$ & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Temperature} & \checkmark & $\times$ & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Visibility} & $\times$ & $\times$ & $\times$ & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Wind} & $\times$ & $\times$ & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \hline\hline
  \multicolumn{2}{|l||}{\textbf{Forecast range (days)}} & 3 & 3 & 0 & $> 7$ & 5 & 5 & 5 & 2& 9 \\
  \hline
  \multicolumn{2}{|l||}{\textbf{Forecasts per day}} & ? & 1 & - & ? & ? & 1 & ? & ? & 4 \\ % TODO
  \hline
...
\begin{table}
\centering
\begin{tabular}{|p{.26\textwidth}|p{.39\textwidth}|p{0.23\textwidth}|}
  \hline
