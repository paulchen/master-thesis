...
\end{tabular}
\begin{tablenotes}
\item[1] \emph{METAR} is standardized by \eacs{ICAO}~\cite{ICAO}. It was introduced in 1968 and has been modified a number of times since. However, most elements remained the same since introduction and can be expected to remain unchanged in the long run.
\end{tablenotes}
\end{threeparttable}
