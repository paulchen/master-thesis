...
\begin{tabular}{|l|l||c|c|c|c|c|c|c|c|c|}
  ...
  \cline{2-11}
  ~ & \textbf{Condition} & $\times$ & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ...
  \cline{2-11}
  ~ & \textbf{Sunrise, sunset} & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Temperature} & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Visibility} & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ~ & \textbf{Wind} & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \hline\hline
  \multirow{9}{*}{\rotatebox{90}{\textbf{Future weather}}} & \textbf{Cloud coverage} & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \cline{2-11}
  ...
  ~ & \textbf{Wind} & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\
  \hline\hline
  \multicolumn{2}{|l||}{\textbf{Forecast range (days)}} & 1 & 1 & 1 & 1 & 1 & 1 & 1 & 1 & 1 \\
  \hline
  \multicolumn{2}{|l||}{\textbf{Forecasts per day}} & 1 & 1 & 1 & 1 & 1 & 1 & 1 & 1 & 1 \\
  \hline
  \multicolumn{2}{|l||}{\textbf{Update interval (hours)}} & 1 & 1 & 1 & 1 & 1 & 1 & 1 & 1 & 1 \\
  \hline
\end{tabular}
