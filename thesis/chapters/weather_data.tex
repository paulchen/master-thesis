...
\begin{itemize}
  ...
  The less complicated a request is, the better the service suits the requirements. Requests in \eacs{HTTP}~\cite{rfc2616} are preferred due to the simplicity of performing requests on the client side in Java using the \emph{Apache HttpComponents project}\footnote{\href{http://hc.apache.org/}{http://hc.apache.org/}}.
...
\begin{tabular}{|p{.2\textwidth}|p{.3\textwidth}|p{0.35\textwidth}|}
  ...
  \hline
  \textbf{\acs{NWS}} & National Weather Service\tnote{1} & \href{http://graphical.weather.gov/xml/}{http://graphical.weather.gov/xml/} \\ % TODO href for NOAA
  \hline
...
\end{tabular}
\begin{tablenotes}
\item[1] part of \eacs{NOAA}, \emph{National Oceanic and Atmospheric Administration}
\end{tablenotes}
\end{threeparttable}
\vspace{.5em}
...
\begin{tabular}{|p{.2\textwidth}|p{.3\textwidth}|p{0.35\textwidth}|}
  ...
  \hline\hline
  \textbf{DWD} & \eacs{SYNOP} (current weather data); not machine-readable weather maps, tables and texts (forecasts) & \eacs{FTP}\tnote{1} \\
  \hline
...
\end{tabular}
\begin{tablenotes}
\item[1] \href{http://tools.ietf.org/html/rfc959}{http://tools.ietf.org/html/rfc959}
\item[2] \href{http://www.noaa.gov/}{http://www.noaa.gov/}
\end{tablenotes}
\end{threeparttable}
\vspace{.5em}
...
\begin{tabular}{|p{.2\textwidth}|p{0.35\textwidth}|}
  ...
  \hline
  \textbf{yr.no} & No account required; data licenced under \emph{CC-BY 3.0}\tnote{1}\\
  \hline
...
\end{tabular}
\begin{tablenotes}
  \item[1] \emph{Creative Commons Attribution 3.0} \href{http://creativecommons.org/licenses/by/3.0}{http://creativecommons.org/licenses/by/3.0}
\end{tablenotes}
\end{threeparttable}
\vspace{.5em}
...
\begin{tabular}{|p{.2\textwidth}|p{0.35\textwidth}|}
  ...
  \hline
  \textbf{Google Weather Feed} & Discontinued \\ % TODO reference
  \hline
...
for the city of Vienna, Austria. An \eacs{HTTP} \emph{GET} request to this \eacs{URL} returns an \eacs{XML} document conforming to the \eacs{XML} \emph{Schema}\cite{xml-schema} definition that can be found online\footnote{\href{http://api.yr.no/weatherapi/locationforecast/1.8/schema}{http://api.yr.no/weatherapi/locationforecast/1.8/schema}}.
online.
