...
\caption{Structure of the \eacs{XML} document returned by the \eacs{API} of \emph{yr.no}; attributes are omitted for better readability.}
...
\caption{A typical \texttt{<time>} element returned by the \eacs{API} of \emph{yr.no}.}
...
\caption{A \texttt{<time>} element returned by the \eacs{API} of \emph{yr.no} describing a period of time.}
