...
\begin{itemize}
  ...
  \item \textbf{Access restrictions, terms of use:} An account is mandatory for access. Account creation is a matter of minutes and new accounts do not need to be approved by DWD. The use of DWD is free for projects like \thinkhome. % TODO inspect terms of use more detailled
  ...
  \item \textbf{Weather updates:} % TODO
\end{itemize}
